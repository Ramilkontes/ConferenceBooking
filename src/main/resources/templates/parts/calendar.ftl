...
<#macro calendar>
    ...
    <table
        ...
        <tr>
            ...
            <th scope="col">
                ...
                <#list 0..week?size-7 as i>
                    <div style="width: ${widthColumn}; height: ${heightColumn}">${week[0]}</div>
                </#list>
            </th>
            <th scope="col">
                Tuesday
                <#list 1..week?size-6 as i>
                    <div style="width: ${widthColumn}; height: ${heightColumn}">${week[1]}</div>
                </#list>
            </th>
            <th scope="col">
                Wednesday
                <#list 2..week?size-5 as i>
                    <div style="width: ${widthColumn}; height: ${heightColumn}">${week[2]}</div>
                </#list>
            </th>
            <th scope="col">
                Thursday
                <#list 3..week?size-4 as i>
                    <div style="width: ${widthColumn}; height: ${heightColumn}">${week[3]}</div>
                </#list>
            </th>
            <th scope="col">
                Friday
                <#list 4..week?size-3 as i>
                    <div style="width: ${widthColumn}; height: ${heightColumn}">${week[4]}</div>
                </#list>
            </th>
            <th scope="col">
                Saturday
                <#list 5..week?size-2 as i>
                    <div style="width: ${widthColumn}; height: ${heightColumn}">${week[5]}</div>
                </#list>
            </th>
            <th scope="col">
                Sunday
                <#list 6..week?size-1 as i>
                    <div style="width: ${widthColumn}; height: ${heightColumn}">${week[6]}</div>
                </#list>
            </th>
        ...
        <tbody>
        <tr>
            <th style="height: ${heightCell}; width: ${widthCell}">00:00</th>
            <#if zero??>
                <th>
                    <#if mondayZero??>
                ...
                <th>
                    <#if saturdayZero??>
                        ...
                        <@inside.example times = saturdayZero flag = SATURDAY />
                    </#if>
                </th>
                <th>
                    <#if sundayZero??>
        ...
        <tr>
            <th style="height: ${heightCell}; width: ${widthCell}">01:00</th>
            <#if one??>
                <th>
                    <#if mondayOne??>
        ...
        <tr>
            <th style="height: ${heightCell}; width: ${widthCell}">02:00</th>
            <#if two??>
                <th>
                    <#if mondayTwo??>
        ...
        <tr>
            <th style="height: ${heightCell}; width: ${widthCell}"
            </th>
            <#if three??>
                <th>
                    <#if mondayThree??>
        ...
        <tr>
            <th style="height: ${heightCell}; width: ${widthCell}">04:00</th>
            <#if four??>
                <th>
                    <#if mondaySixFour??>
        ...
        <tr>
            <th style="height: ${heightCell}; width: ${widthCell}">05:00</th>
            <#if five??>
                <th>
                    <#if mondayFive??>
        ...
        <tr>
            <th style="height: ${heightCell}; width: ${widthCell}">06:00</th>
            <#if six??>
                <th>
                    <#if mondaySix??>
        ...
        <tr>
            <th style="height: ${heightCell}; width: ${widthCell}">07:00</th>
            <#if seven??>
                <th>
                    <#if mondaySeven??>
        ...
        <tr>
            <th style="height: ${heightCell}; width: ${widthCell}">08:00</th>
            <#if eight??>
                <th>
                    <#if mondayEight??>
        ...
        <tr>
            <th style="height: ${heightCell}; width: ${widthCell}">09:00</th>
            <#if nine??>
                <th>
                    <#if mondayNine??>
        ...
        <tr>
            <th style="height: ${heightCell}; width: ${widthCell}">10:00</th>
            <#if ten??>
                <th>
                    <#if mondayTen??>
        ...
        <tr>
            <th style="height: ${heightCell}; width: ${widthCell}">11:00</th>
            <#if eleven??>
                <th>
                    <#if mondayEleven??>
        ...
        <tr>
            <th style="height: ${heightCell}; width: ${widthCell}">12:00</th>
            <#if twelve??>
                <th>
                    <#if mondayTwelve??>
        ...
        <tr>
            <th style="height: ${heightCell}; width: ${widthCell}">13:00</th>
            <#if thirteen??>
                <th>
                    <#if mondayThirteen??>
        ...
        <tr>
            <th style="height: ${heightCell}; width: ${widthCell}">14:00</th>
            <#if fourteen??>
                <th>
                    <#if mondayFourteen??>
        ...
        <tr>
            <th style="height: ${heightCell}; width: ${widthCell}">15:00</th>
            <#if fifteen??>
                <th>
                    <#if mondayFifteen??>
        ...
        <tr>
            <th style="height: ${heightCell}; width: ${widthCell}">16:00</th>
            <#if sixteen??>
                <th>
                    <#if mondaySixteen??>
        ...
        <tr>
            <th style="height: ${heightCell}; width: ${widthCell}">17:00</th>
            <#if seventeen??>
                <th>
                    <#if mondaySeven??>
        ...
        <tr>
            <th style="height: ${heightCell}; width: ${widthCell}">18:00</th>
            <#if eighteen??>
                <th>
                    <#if mondayEighteen??>
        ...
        <tr>
            <th style="height: ${heightCell}; width: ${widthCell}">19:00</th>
            <#if nineteen??>
                <th>
                    <#if mondayNineteen??>
        ...
        <tr>
            <th style="height: ${heightCell}; width: ${widthCell}">20:00</th>
            <#if twenty??>
                <th>
                    <#if mondayTwenty??>
        ...
        <tr>
            <th style="height: ${heightCell}; width: ${widthCell}">21:00</th>
            <#if twentyOne??>
                <th>
                    <#if mondayTwentyOne??>
        ...
        <tr>
            <th style="height: ${heightCell}; width: ${widthCell}">22:00</th>
            <#if twentyTwo??>
                <th>
                    <#if mondayTwentyTwo??>
        ...
        <tr>
            <th style="height: ${heightCell}; width: ${widthCell}">23:00</th>
            <#if twentyThree??>
                <th>
